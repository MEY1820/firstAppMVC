    ...
    public partial class MigrationPrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AutorFiguraID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutorFigura", x => x.AutorFiguraID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Figura_AutorFigura_AutorFiguraID",
                        column: x => x.AutorFiguraID,
                        principalTable: "AutorFigura",
                        principalColumn: "AutorFiguraID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Figura_AutorFiguraID",
                table: "Figura",
                column: "AutorFiguraID");
